document.addEventListener('DOMContentLoaded', () => {
    ...
    const mockBills = [
        { id: 1, name: 'Conta de Luz', dueDate: '2025-10-05', value: 150.75, status: 'A Vencer', category: 'Moradia', icon: 'fa-lightbulb' },
        { id: 2, name: 'Internet', dueDate: '2025-10-10', value: 99.90, status: 'A Vencer', category: 'Utilidades', icon: 'fa-wifi' },
        { id: 3, name: 'Aluguel', dueDate: '2025-09-10', value: 2200.00, status: 'Paga', category: 'Moradia', icon: 'fa-house' },
        { id: 4, name: 'Cartão de Crédito', dueDate: '2025-09-15', value: 850.40, status: 'Paga', category: 'Finanças', icon: 'fa-credit-card' },
        { id: 5, name: 'Conta de Água', dueDate: '2025-10-20', value: 85.50, status: 'A Vencer', category: 'Moradia', icon: 'fa-tint' },
        { id: 6, name: 'Academia', dueDate: '2025-09-28', value: 120.00, status: 'Vencida', category: 'Saúde', icon: 'fa-dumbbell' },
        { id: 7, name: 'Netflix', dueDate: '2025-11-01', value: 55.90, status: 'Agendada', category: 'Lazer', icon: 'fa-tv' },
